    ...
    return (
        <form className='flex flex-col  gap-3'>
            ...
            {itemType === 'ucard' && (
                <button
                    type="button"
                    className='w-full bg-black text-white rounded-xl py-3 px-4 flex justify-center items-center space-x-2 hover:bg-gray-800 transition-colors'
            ...
            <button type = 'submit' className='w-full flex items-center justify-center bg-gray-400 text-whhite rounded-xl py-3 px-4 space-x-2 hover:bg-gray-500 transition-colors' >
